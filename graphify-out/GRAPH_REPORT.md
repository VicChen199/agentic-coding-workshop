...
3. `getCourses()` - 11 edges
4. `cn()` - 11 edges
5. `reviewsForCourse()` - 9 edges
6. `Course` - 9 edges
7. `CoursePage()` - 8 edges
8. `Button` - 8 edges
9. `filterCourses()` - 8 edges
10. `readSchedule()` - 8 edges
...
### Community 0 - "catalog.tsx"
Cohesion: 0.25
Nodes (12): GET(), HomePage(), Catalog(), CatalogProps, PAGE_SIZE, pageCount(), paginate(), searchCourses() (+4 more)

### Community 1 - "schedule-board.tsx"
Cohesion: 0.18
Nodes (13): SchedulePage(), AddToSchedule(), DAYS, ScheduleBoard(), Button, ButtonProps, buttonVariants, missingPrerequisites() (+5 more)
...
### Community 5 - "[code]/page.tsx"
Cohesion: 0.20
Nodes (20): CourseRouteProps, GET(), CoursePage(), CoursePageProps, CourseCard(), CourseCardProps, Card, CardContent (+12 more)
...
### Community 12 - "filter.test.ts"
Cohesion: 0.10
Nodes (25): CatalogFilters(), MEETING_DAYS, MIN_RATING_OPTIONS, setMembership(), TIME_OPTIONS, WORKLOAD_OPTIONS, data_seed, CourseFilters (+17 more)
...
- **Why does `next` connect `next` to `schedule-board.tsx`, `package.json`, `[code]/page.tsx`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `react` connect `schedule-board.tsx` to `catalog.tsx`, `package.json`, `filter.test.ts`, `[code]/page.tsx`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `vitest` connect `catalog.tsx` to `schedule-board.tsx`, `package.json`, `filter.test.ts`, `eslint.config.mjs`?**
